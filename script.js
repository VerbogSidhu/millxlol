...
(function () {
  ...
  var QUOTES = [
    ...
    { text: "I JUST WENT ON NHENTAI WITHOUT A VPN", by: "Slash" },
    { text: "darlking in the dih", by: "Renascent" },
    { text: "lmao little asian boy are you hot", by: "Slash" },
    { text: "this guy rated lesbian space princess the same as the odyssey", by: "Mountable" },
    { text: "#1 edater fan right here", by: "pbsi" },
    { text: "Fortnitwe MIKU!", by: "Slash" },
    { text: "like i would have this in the background when i jerk", by: "Renascent" },
    { text: "pp bounce music", by: "Renascent" },
    { text: "Mao mao is so fucking bad", by: "Noko" },
    { text: "i love feet.", by: "Renascent" },
    { text: "PERSONA 4 REVIVAL PLZ RELEASE EARLY 🙏", by: "Millx" },
    { text: "im sure i commited my api keys to this", by: "Millx" },
    { text: "both jd vance and donald trump public hanging PLZ", by: "Millx" },
    { text: "is $17 for a persona 5 ballpoint pen worth it", by: "Millx" },
    { text: "Don't stop, don't stop till the finish!", by: "Slash" },
    { text: "Lambda and Rena can we have a threesome", by: "Ssammyk" },
    { text: "who want my ip address", by: "jdnnle6" },
    { text: "Beatrice *plap* *plap* *plap* Mhm~ *plap* *plap*", by: "Slash" },
    { text: "Bees have some sturdy poop.", by: "Mountable" },
    { text: "No it didn't happen because nasa built a separate planet out of bee shit and slowly switched us onto it while we were sleeping.", by: "Mountable" },
    { text: "go fuck yourself millx", by: "Slash" },
    { text: "Can't have anything fun happen with these fucking Jews around.", by: "Mountable" },
